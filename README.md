...
const toggledSettings = {
    ...
    container: {
      ...
      toggledColor: 'blue', // Specifies the outer container background color when toggled.
      defaultColor: 'red', // Specifies the outer container background color when the toggle is not toggled. 

    },
    inner: {
      toggledColor: 'blue', // Specifies the inner circle background color when toggled.
